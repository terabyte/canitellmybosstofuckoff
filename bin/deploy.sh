...
DEPLOY_PATH="/var/www/cani/canitellmybosstofuckoff/.git"
KEYHOLE_USER="root"
DEPLOY_USER="www-data"
DEPLOY_BRANCH="prod"
DEPLOY_SERVICE_NAME="cani"
...
echo "Updating repo..."
ssh "$KEYHOLE_USER@$DEPLOY_HOST" "cd /var/www/cani/canitellmybosstofuckoff && sudo -u \"$DEPLOY_USER\" git reset --hard \"origin/$DEPLOY_BRANCH\""
